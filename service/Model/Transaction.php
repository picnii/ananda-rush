...
{
    $sql = "SELECT *, m.projID as project_code, tap.id as main_appointment_log_id , tapl.payment as appoint_payment
...
{    
            if($pre_id){
                    $SQL1 ="select  s.*,p.id_preapprove as Preapp_id_preapprove,p.itemid as Preapp_itemid,p.appoint_reason2_id as Preapp_appoint_reason2_id";
                     ...
                     $SQL1.=" ,tapl.payment_type , tapl.appoint_time, tapl.people, tapl.call_time, tap.id as main_appointment_log_id, tapl.payment as appoint_payment ";
